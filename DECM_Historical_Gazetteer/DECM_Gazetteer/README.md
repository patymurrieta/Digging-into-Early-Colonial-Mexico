...
``` 
Murrieta-Flores, P., Jiménez-Badillo, D., Martins, B., Liceras-Garrido, R., Favila-Vázquez, M., and Bellamy, K. (2020) 
...
The DECM historical gazetteer was created in the context of the “[Digging into Early Colonial Mexico](https://www.lancaster.ac.uk/digging-ecm/)” project, and it is a digital directory of historical places of Mexico and Guatemala created from information contained in primary sources, research carried out by the team, as well as information collected from comprehensive studies on the political, religious, and administrative units of the Viceroyalty of New Spain.

The research resulted in the ***DECM Online Gazetteer*** and the ***DECM GIS Dataset*** that we have divided in three parts:
